  ...
  DEFINE: {
    ...
    RESOURCES: {
      ...
      TRANSACTION: {
        ...
        EXAMPLES: {
          EX1:
            "Define a transaction named TRN1 for the program named PGM123 to the region named MYREGION " +
      ...
      URIMAP: {
        ...
        OPTIONS: {
          ...
          PIPELINENAME:
            "The name of the PIPELINE resource definition for the URIMAP. " +
          ...
          TRANSACTIONNAME:
            "The name of the TRANSACTION resource definition for the URIMAP. " +
            "The maximum length of the transaction name is four characters.",
          WEBSERVICENAME:
            "The name of the WEBSERVICE resource definition for the URIMAP. " +
      ...
      WEBSERVICE: {
        ...
        OPTIONS: {
          PIPELINENAME:
            "The name of the PIPELINE resource definition for the web service." +
            " The maximum length of the pipeline name is eight characters",
  ...
  INSTALL: {
    ...
    RESOURCES: {
      ...
      TRANSACTION: {
        ...
        EXAMPLES: {
          EX1:
            "Install a transaction named TRN1 to the region named MYREGION " +
            "in the CSD group MYGRP",
        },
      },
      URIMAP: {
