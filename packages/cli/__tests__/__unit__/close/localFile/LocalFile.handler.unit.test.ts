...
// Template: codegen/templates/tests/cli.shared.handler.unit.test.hbs
...
describe("CloseLocalFileHandler", () => {
  ...
  it("should call the closeLocalFile api with action options", async () => {
    const handler = new LocalFileHandler();
