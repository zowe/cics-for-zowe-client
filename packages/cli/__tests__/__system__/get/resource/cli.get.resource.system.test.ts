...
describe("cics get resource", () => {
  ...
  fit("should display the help", async () => {
    const response = await runCliScript(
      __dirname + "/__scripts__/get_resource_help.sh",
      TEST_ENVIRONMENT,
    );
  ...
  it("should be able to successfully get resources", async () => {
    const output = runCliScript(
      __dirname + "/__scripts__/get_resource.sh",
      TEST_ENVIRONMENT,
  ...
  it("should be able to successfully get resources using profile options", async () => {
    const output = runCliScript(
      __dirname + "/__scripts__/get_resource_fully_qualified.sh",
      TEST_ENVIRONMENT,
      [
        "CICSProgram",
        regionName,
