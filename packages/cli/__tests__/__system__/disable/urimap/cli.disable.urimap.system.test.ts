...
describe("CICS disable urimap command", () => {
  ...
  it("should be able to disable a urimap of type server with basic options", async () => {
    ...
    output = runCliScript(__dirname + "/../../install/urimap/__scripts__/install_urimap.sh", TEST_ENVIRONMENT, [urimapName, csdGroup, regionName]);
    ...
    output = runCliScript(__dirname + "/../../enable/urimap/__scripts__/enable_urimap.sh", TEST_ENVIRONMENT, [urimapName, regionName]);
    stderr = output.stderr.toString();
    expect(stderr).toEqual("");
    expect(output.status).toEqual(0);
    expect(output.stdout.toString()).toContain("success");
    ...
    output = runCliScript(__dirname + "/__scripts__/disable_urimap.sh", TEST_ENVIRONMENT, [urimapName, regionName]);
    stderr = output.stderr.toString();
    expect(stderr).toEqual("");
    expect(output.status).toEqual(0);
    expect(output.stdout.toString()).toContain("success");
    ...
    output = runCliScript(__dirname + "/../../discard/urimap/__scripts__/discard_urimap.sh", TEST_ENVIRONMENT, [urimapName, regionName]);
    stderr = output.stderr.toString();
    expect(stderr).toEqual("");
    expect(output.status).toEqual(0);
    expect(output.stdout.toString()).toContain("success");
    ...
    output = runCliScript(__dirname + "/../../delete/urimap/__scripts__/delete_urimap.sh", TEST_ENVIRONMENT, [urimapName, csdGroup, regionName]);
    stderr = output.stderr.toString();
    expect(stderr).toEqual("");
    expect(output.status).toEqual(0);
    expect(output.stdout.toString()).toContain("success");
