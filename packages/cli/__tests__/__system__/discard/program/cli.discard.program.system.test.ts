...
describe("CICS discard program command", () => {
  ...
  it("should be able to display the help", () => {
    const output = runCliScript(
      __dirname + "/__scripts__/discard_program_help.sh",
      TEST_ENVIRONMENT,
      [],
    );
  ...
  it("should be able to successfully discard a program with basic options", async () => {
    ...
    const programName =
      "AAA" + generateRandomAlphaNumericString(programNameSuffixLength);
    ...
    output = runCliScript(
      __dirname + "/../../install/program/__scripts__/install_program.sh",
      TEST_ENVIRONMENT,
      [programName, csdGroup, regionName],
    );
    ...
    output = runCliScript(
      __dirname + "/__scripts__/discard_program.sh",
      TEST_ENVIRONMENT,
  ...
  it("should be able to successfully discard a program with profile options", async () => {
    ...
    output = runCliScript(
      __dirname +
        "/../../install/program/__scripts__/install_program_fully_qualified.sh",
      TEST_ENVIRONMENT,
      [
        programName,
        csdGroup,
    ...
    output = runCliScript(
      __dirname + "/__scripts__/discard_program_fully_qualified.sh",
      TEST_ENVIRONMENT,
      [
        programName,
        regionName,
