...
describe("CICS install transaction command", () => {
  ...
  it("should be able to display the help", () => {
    const output = runCliScript(
      __dirname + "/__scripts__/install_transaction_help.sh",
      TEST_ENVIRONMENT,
      [],
    );
  ...
  it("should be able to successfully install a transaction with basic options", async () => {
    ...
    output = runCliScript(
      __dirname + "/__scripts__/install_transaction.sh",
      TEST_ENVIRONMENT,
  ...
  it("should be able to successfully install a transaction with profile options", async () => {
    ...
    output = runCliScript(
      __dirname + "/__scripts__/install_transaction_fully_qualified.sh",
      TEST_ENVIRONMENT,
      [
        transactionName,
        csdGroup,
