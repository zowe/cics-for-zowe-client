...
export async function getCicsSection(view: SideBarView): Promise<DefaultTreeSection | undefined> {
...
export async function clickPlusIconInCicsTree(cicsTree: DefaultTreeSection | undefined): Promise<void> {
...
export async function selectEditProjectTeamConfigFile(cicsTree: DefaultTreeSection | undefined): Promise<void> {
