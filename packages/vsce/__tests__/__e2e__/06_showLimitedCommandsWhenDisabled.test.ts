import { countCicsCommands} from "./util/globalMocks";
...
describe("Test suite for showing Limited commands in Command Palette", () => {
  it("Should display less than 5 commands when the property is set to False", async function () {
    ...
    expect(countFalse).to.be.lessThan(5);
