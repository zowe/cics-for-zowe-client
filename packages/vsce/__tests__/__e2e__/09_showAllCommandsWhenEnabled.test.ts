...
import { countCommandsFromPalette, getCommandPaletteLabels, openSettingsJsonEditor, removeUserSetting } from "./util/globalMocks";
...
describe("Test suite for showing all commands in Command Palette", () => {
  it("Should display more than 5 commands when the property is set to True", async function () {
    // assume true await updateUserSetting("zowe.cics.showAllCommandsInPalette",true);
