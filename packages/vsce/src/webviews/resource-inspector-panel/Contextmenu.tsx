...
const DropDownContent = ({ children }: DropDownContentProps) => {
  ...
  return createPortal(
    <div
      className="fixed z-50 flex flex-col bg-(--vscode-editor-background) min-w-48 rounded-lg p-1 border border-(--vscode-disabledForeground)"
...
export const ContextMenu = ({ data, tabIndex }: { data: { label: string; value: string; resourceName: string; resourceContext: IResourceContext; resources: IResourceInspectorResource[]; }[]; tabIndex?: number; }) => {
  return (
    <DropDown>
