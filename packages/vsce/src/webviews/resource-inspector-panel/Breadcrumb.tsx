    ...
    <div className="flex items-center gap-2">
      ...
      >
        {showFullPath && showTooltip && (
          <div className="bg-(--vscode-panel-background) rounded-md shadow-lg text-(--vscode-foreground) text-xs border border-(--vscode-disabledForeground) px-2 py-1 absolute left-0 top-5 flex items-center gap-1 z-50">
            {profileName && (
              <>
        ...
        <div className="flex gap-1 items-center">
          {props.resourceIconPath && (
            <img
              src={isDark ? props.resourceIconPath.dark : props.resourceIconPath.light}
              alt="RES"
              width="16px"
              height="16px"
            />
      ...
      {props.actions && props.actions.length > 0 && props.resources && (
        <ContextMenu
