...
export const URIMapMeta: IResourceMeta<IURIMap> = {
  ...
  getDefaultCriteria: function () {
    return PersistentStorage.getResourceDefaultFilter(CicsCmciConstants.CICS_URIMAP, "uriMap");
  },
  ...
  async appendCriteriaHistory(criteria: string) {
    await PersistentStorage.appendResourceSearchHistory("urimaps", criteria);
  },

  async getCriteriaHistory() {
    return PersistentStorage.getResourceSearchHistory("urimaps");
  },
};
