...
export function getFilterAllProgramsCommand(
  tree: CICSTree,
  ...
  return commands.registerCommand(
    ...
    async (node) => {
      ...
      if (node) {
        ...
        selection[selection.length - 1] instanceof CICSCombinedProgramTree
      ) {
...
export function getFilterAllTasksCommand(
  tree: CICSTree,
  treeview: TreeView<any>,
) {
  return commands.registerCommand(
    ...
    async (node) => {
      ...
      if (node) {
        ...
        selection[selection.length - 1] &&
        selection[selection.length - 1] instanceof CICSCombinedTaskTree
      ) {
        chosenNode = selection[selection.length - 1];
      } else {
...
export function getFilterAllLibrariesCommand(
  tree: CICSTree,
  treeview: TreeView<any>,
) {
  return commands.registerCommand(
    ...
    async (node) => {
      ...
      if (node) {
        ...
        selection[selection.length - 1] &&
        selection[selection.length - 1] instanceof CICSCombinedLibraryTree
      ) {
        chosenNode = selection[selection.length - 1];
      } else {
...
export function getFilterAllTCPIPServicesCommand(
  tree: CICSTree,
  treeview: TreeView<any>,
) {
  return commands.registerCommand(
    ...
    async (node) => {
      ...
      if (node) {
        ...
        selection[selection.length - 1] &&
        selection[selection.length - 1] instanceof CICSCombinedTCPIPServiceTree
      ) {
        chosenNode = selection[selection.length - 1];
      } else {
...
export function getFilterAllTransactionsCommand(
  tree: CICSTree,
  treeview: TreeView<any>,
) {
  return commands.registerCommand(
    ...
    async (node) => {
      ...
      if (node) {
        ...
        selection[selection.length - 1] &&
        selection[selection.length - 1] instanceof CICSCombinedTransactionsTree
      ) {
        chosenNode = selection[selection.length - 1];
      } else {
...
export function getFilterAllLocalFilesCommand(
  tree: CICSTree,
  treeview: TreeView<any>,
) {
  return commands.registerCommand(
    ...
    async (node) => {
      ...
      if (node) {
        ...
        selection[selection.length - 1] &&
        selection[selection.length - 1] instanceof CICSCombinedLocalFileTree
      ) {
        chosenNode = selection[selection.length - 1];
      } else {
...
export function getFilterAllURIMapsCommand(
  tree: CICSTree,
  treeview: TreeView<any>,
) {
  return commands.registerCommand(
    ...
    async (node) => {
      ...
      if (node) {
        ...
        selection[selection.length - 1] &&
        selection[selection.length - 1] instanceof CICSCombinedURIMapTree
      ) {
        chosenNode = selection[selection.length - 1];
      } else {
...
export function getFilterAllPipelinesCommand(
  tree: CICSTree,
  treeview: TreeView<any>,
) {
  return commands.registerCommand(
    ...
    async (node) => {
      ...
      if (node) {
        ...
        selection[selection.length - 1] &&
        selection[selection.length - 1] instanceof CICSCombinedPipelineTree
      ) {
        chosenNode = selection[selection.length - 1];
      } else {
...
export function getFilterAllWebServicesCommand(
  tree: CICSTree,
  treeview: TreeView<any>,
) {
  return commands.registerCommand(
    ...
    async (node) => {
      ...
      if (node) {
        ...
        selection[selection.length - 1] &&
        selection[selection.length - 1] instanceof CICSCombinedWebServiceTree
      ) {
        chosenNode = selection[selection.length - 1];
      } else {
