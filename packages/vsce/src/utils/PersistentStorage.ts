...
class SCICSPersistentStorage {
  ...
  async appendPersistedCICSProfile(profileNameToAppend: string) {
    const profiles: Set<string> = new Set([...this.getPersistedCICSProfiles()]);
