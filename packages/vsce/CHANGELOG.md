...
- Enhancement: Added an event to the Resource Inspector command so the subscribers can be notified of this. [#425](https://github.com/zowe/cics-for-zowe-client/issues/425)
...
- Enhancement: Added User-Agent header to all CMCI requests. [#412](https://github.com/zowe/cics-for-zowe-client/issues/412)
