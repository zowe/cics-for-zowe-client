...
- Enhancement: Added Resource Inspector actions for bundles, pipelines, and web-services. [#634](https://github.com/zowe/cics-for-zowe-client/issues/634)

## `3.23.0`

- Enhancement: Added Resource Inspector actions for library, tasks, JVM Servers, JVM Endpoint. [#634](https://github.com/zowe/cics-for-zowe-client/issues/634)
...
- Enhancement: When a CMCI request returns incomplete results due to an error, an informational `ⓘ` badge and tooltip are shown on the affected tree node with resp code details and a link to IBM documentation. [#695](https://github.com/zowe/cics-for-zowe-client/issues/695)
