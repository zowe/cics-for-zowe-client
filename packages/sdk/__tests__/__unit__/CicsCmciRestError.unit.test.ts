...
describe("CicsCmciRestError tests", () => {
  it("should create error with full feedback information", () => {
    ...
    expect(error.RESPONSE_1).toBe(1024);
    ...
    expect(error.FEEDBACKRESP).toBe(100);
    expect(error.FEEDBACKRESP_2).toBe(200);
  ...
  it("should handle missing errors object", () => {
    ...
    expect(error.RESPONSE_1).toBe(1024);
    expect(error.RESPONSE_2).toBe(512);
    expect(error.FEEDBACKRESP).toBe(0); // DEFAULT_RESP_CODE
    expect(error.FEEDBACKRESP_2).toBe(0); // DEFAULT_RESP_CODE
